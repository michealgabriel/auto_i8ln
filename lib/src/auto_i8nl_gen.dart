...
class AutoI8lnGen {
  ...
  List<String> supportedLocaleNames = ['English', 'French', 'German', 'Spanish', 'Italian'];
  ...
  String getLocaleISOByName(String localeName) {
    return autoI8lnGen.supportedLocales[autoI8lnGen.supportedLocaleNames.indexOf(localeName)];
  }
